    ...
    <div {...props}>
      ...
      {open && (
        <div className="fixed grid top-8 left-8 bottom-8 right-8 bg-[#b0dbbf] rounded-lg p-4 grid-rows-[auto,1fr,auto] gap-4 shadow-lg shadow-slate-800/20 z-50">
            ...
            <>
              ...
              <div className="overflow-auto max-h-full">
                <p className="text-black text-start">
                  The strength of a poker hand is determined by the best
                  combination of 5 cards from a maximum of 7 cards (2 cards in
                  your hand and 5 on the table). The following list shows the
            ...
            <>
              ...
              <div className="grid content-start px-2 gap-6">
                <p className="text-black">
                  <b>flop</b> is a poker game of skill and strategy. The goal is
                  to win as large of a pot as possible by betting on the
                  strength of your hand.
                </p>
                <p className="text-black">
                  The game is played in rounds, with each round consisting of a
                  series of betting actions. The player with the best hand at
                  the end of the round wins the pot.
                </p>
                <p className="text-black">
                  To start a round, click the &quot;Start Game&quot; button. You
                  will be dealt two cards, and the flop (three community cards)
                  will be revealed. You can then choose to fold, check, raise,
                  or call.
                </p>
                <p className="text-black">
                  The game ends when all players have folded, or when the final
                  round of betting is complete. The player with the best hand
                  wins the pot.
                </p>
              </div>
            </>
          ...
          <button
            className="absolute top-2 left-2 w-8 h-8 m-2"
            onClick={() => {
              setOpen(false);
            }}
          >
